...
from pysit_extensions.same_model_invert_baseline_and_monitor_data.optimization_hacked import *
...
class LBFGS(OptimizationBase):
    ...
    def __init__(self, objective_0, objective_1 = None, memory_length=None, reset_on_new_inner_loop_call=True, geom_fac = 0.6, geom_fac_up = 0.7, scale_step = False, store_shot_contributions = False, *args, **kwargs):
        ...
        OptimizationBase.__init__(self, objective_0, objective_1, geom_fac = geom_fac, geom_fac_up = geom_fac_up, store_shot_contributions = store_shot_contributions, *args, **kwargs)
    ...
    def _select_step(self, shots_0, shots_1, current_objective_value, gradient, iteration, objective_arguments, **kwargs):
        ...
        alpha = self.select_alpha(shots_0, shots_1, gradient, direction, objective_arguments,
